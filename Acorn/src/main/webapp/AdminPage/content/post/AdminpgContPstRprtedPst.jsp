...
<h1>신고된 게시글</h1>
<hr>
<form action = "<%=request.getContextPath() %>/AdminPostReported">
...
<script type = "text/javascript">
	...
	$(document).ready(function(){
		...
		function delChecked(){
			...
			//전송
			location.href = "AdminPostDeleteServlet?postArr="+postArr;
		}//delChecked
		...
		function showContent(){
			...
			var childWin = window.open("<%=request.getContextPath() %>/AdminPage/content/post/childWin/postChildWin.jsp", 
					width = "300px", 
					height = "300px");
